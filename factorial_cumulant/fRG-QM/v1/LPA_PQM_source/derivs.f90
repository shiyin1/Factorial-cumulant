...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  nb=Fnb((k*Sqrt(1 + mp2)-muq*0.-muqb*0.)/Sqrt(zb),T)
  ...
  nb=Fnb((k*Sqrt(1 + ms2)-muq*0.-muqb*0.)/Sqrt(zb),T)
  call nbdx(nb,nbd0x,nbd1x,nbd2x,nbd3x,nbd4x,nbd5x)
  nbSigma=nbd0x
  nbd1xSigma=nbd1x
  nbd2xSigma=nbd2x
  ...
  xff=-mu - muq + (k*Sqrt(1 + mf2))/zf
  xfa= mu - muqb + (k*Sqrt(1 + mf2))/zf
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  etaphi=-((f2a*h**2*Nc*v3 - (8*f3a*h**2*Nc*v3)/3.Q+0 -                            &
      (4*b2b2PS*lam2**2*rho*v3)/(3.Q+0*k**2) +                                     &
      ((b2f1aSigma*h**2 + b2f1aPion*h**2*(-1 + Nf**2))*v3*                      &
         ((-2*f2a*h**2*Nc*v3)/3.Q+0 + (4*f3a*h**2*Nc*v3)/3.Q+0))/(3.Q+0*Nf))/            &
    (1 - ((b2f1aSigma*h**2 + b2f1aPion*h**2*(-1 + Nf**2))*v3*                   &
         ((-2*f2a*h**2*Nc*v3)/3.Q+0 + (4*f3a*h**2*Nc*v3)/3.Q+0))/(12.Q+0*Nf)))
  ...
  (2.Q+0*k**2*(18*Nf - b2f1aPion*f2a*h**4*Nc*v3**2 +                               &
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  dydx(Nv+1)=dlam0dt
  dydx((Nv+1)+1)=0.!dhdt
  dydx((Nv+1)+(Nh+1)+1)=0.!dZphidt
  dydx((Nv+1)+(Nh+1)+2)=0.!dZpsidt
