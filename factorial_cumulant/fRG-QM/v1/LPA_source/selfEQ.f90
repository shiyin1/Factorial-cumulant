...
!Inputing guess kappa_UV_i,l_i,lb_i, outputing kappa_UV,l,lb and other physical variables
  ...
  real(16) T,mu,muq,muqb !temperature and chemical potential
  integer i,j
  ...
  real(16) x_aft(npoint1),y_aft(npoint1) !used for interpolation
  ...
  real(16) kk,lam1k,lam2k,lam3k,lam4k,lam5k,lam0k,hk,Zphik,Zpsik,ck,kappak,etaphik,etapsik
